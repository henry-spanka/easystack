# The role for the OpenStack slave controller(s) with Ceph and NFS
class easystack::role::ha::controller::ceph::slave_nfs inherits ::easystack::role {

    require ::easystack::profile::network::controller_ceph
