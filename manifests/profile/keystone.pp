...
class easystack::profile::keystone (
    ...
    firewalld_port { 'Allow keystone admin endpoint on port 35357 tcp - zone=internal':
        ensure   => present,
        zone     => 'internal',
        port     => 35357,
        protocol => 'tcp',
    ...
    firewalld_port { 'Allow keystone admin endpoint on port 35357 tcp - zone=admin':
        ensure   => present,
        zone     => 'admin',
        port     => 35357,
        protocol => 'tcp',
    ...
    class { 'keystone':
        ...
        public_endpoint         => "https://${public_endpoint}:5000",
        admin_endpoint          => "https://${admin_endpoint}:35357",
        sync_db                 => $sync_db,
